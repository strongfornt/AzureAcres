...
export default function Footer() {
  return (
    <>
    <footer data-aos="fade-up"  data-aos-duration="1000"  className="px-4 divide-y border-t border-[#626161]">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
			<div className="flex items-center justify-center w-12 h-12 rounded-full ">
				<img   data-aos="zoom-in-right" data-aos-delay="500 " data-aos-duration="1000" 
				src={logo} alt="" />
				</div> 
				
				<span  data-aos="zoom-in-up" data-aos-delay="500 " data-aos-duration="1000"  className="font-extrabold  text-2xl  bg-300%  bg-gradient-to-r from-accent/75 via-info/75 to-success/75 text-transparent bg-clip-text animate-gradient">AzureAcres</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3">
				<div
				data-aos="fade-down" data-aos-delay="500 " data-aos-duration="1000"
				className="uppercase dark:text-gray-900">Social media</div>
				<div className="flex justify-start space-x-3">
					<a 
					data-aos="zoom-in-left" data-aos-delay="3000 " data-aos-duration="800"
					data-aos-easing="ease-in-out"
					rel="noopener noreferrer" href="#" title="Facebook" className="flex items-center p-1">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
							<path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z"></path>
						</svg>
					</a>
					<a 
					data-aos="zoom-in-left" data-aos-delay="3500 " data-aos-duration="1000"
					data-aos-easing="ease-in-out"
					rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center p-1">
					...
					<a
					data-aos="zoom-in-left" data-aos-delay="4000 " data-aos-duration="1200"
					data-aos-easing="ease-in-out"
					rel="noopener noreferrer" href="#" title="Instagram" className="flex items-center p-1">
