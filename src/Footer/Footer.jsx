...
export default function Footer() {
  return (
    <>
    <footer className="px-4 divide-y border-t">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			...
			<div className="flex items-center justify-center w-12 h-12 rounded-full ">
				...
				<span className="font-extrabold  text-2xl  bg-300%  bg-gradient-to-r from-accent/75 via-info/75 to-success/75 text-transparent bg-clip-text animate-gradient">AzureAcres</span>
			</a>
		</div>
